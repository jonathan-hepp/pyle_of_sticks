...
from sticks_game import PileOfSticks, Game, ComputerPlayer, HumanPlayer, EndOfGame
...
# some safe checking could be done here, just in case, but since we 
# only read and append, it's not really an issue. 
global_pool = [[1,2,3] for x in range(21)]

def new_game_builder(human_player = None, computer_player = None):
    if computer_player is None:
        computer_player = ComputerPlayer()
        computer_player.pool = global_pool
